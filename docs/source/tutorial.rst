...
+++++++++++++++++
  ...
  To load a project, expand the 'Project' box and select 'Load'.
  
  .. image:: _images/tutorial/static/load_project.png
     :width: 100%
...
+++++++++++++++++
  ...
  There are many ways to clean these kind of images up. We mostly use deep learning noise filtering, such as `Noise2Void <https://github.com/juglab/n2v>`_, or channel subtraction. In `Cecelia` channel subtraction is imolemented as taking the ratio between channels. Select the image in the `Cleanup images` section and select 'Autofluorescence Correction' as method. For each channel define the denominator, which in this case is the autofluorescence channel (`AF`) that was generated after spectral unmixing.
